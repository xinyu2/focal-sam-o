...
class ViT_Tuner(nn.Module):
    ...
    """
    def __init__(self, args, vit_model, num_classes):
        super().__init__()
        ...
        use_full_tuning = args.full_tuning
        use_bias_tuning = args.bias_tuning
        use_ln_tuning = args.ln_tuning
        use_vpt_shallow = args.vpt_shallow
        use_vpt_deep = args.vpt_deep
        use_adapter = args.adapter
        use_adaptformer = args.adaptformer
        use_lora = args.lora
        use_lora_mlp = args.lora_mlp
        use_ssf_attn = args.ssf_attn
        use_ssf_mlp = args.ssf_mlp
        use_ssf_ln = args.ssf_ln
        use_mask = args.mask
        partial = args.partial
        vpt_len = args.vpt_len
